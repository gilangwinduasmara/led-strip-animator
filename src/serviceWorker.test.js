...
test("1", () => {
  let callFunction = () => { serviceWorker.register("bus_account.mpe") }
...
test("3", () => {
  let callFunction = () => { serviceWorker.register("png.mpg4") }
...
test("4", () => {
  let callFunction = () => { serviceWorker.register("arizona_extend.wav") }
...
describe("checkValidServiceWorker", () => {
  ...
  checkValidServiceWorker("www.google.com",
                          "services_recontextualize_front_end.gif")
        }
...
test("4", () => {
  ...
  checkValidServiceWorker(undefined, undefined)
    ...
    describe("serviceWorker.unregister",
             () => {test("0", () => {
               let callFunction = () => { serviceWorker.unregister() }
